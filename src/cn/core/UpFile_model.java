...
{   HttpServletRequest request;
    ...
    {  String fileName=null;
       try{  String tempFileName=(String)session.getId();//客户的session的id
            File f1=new File("G:/web/wzcszy/WebContent/images/model",tempFileName);
           ...
           //客户上传的文件的名字是：
            ...
            //session传值
            session.setAttribute("mpic",fileName);
            ...
            File f2= new File("G:/web/wzcszy/WebContent/images/model",fileName); 
