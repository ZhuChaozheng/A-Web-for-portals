...
public class HtmlUtils {
	...
	public static String table(int step, int row, int page, String http,
		...
		String str = "<table   style='font-size:10pt;' ><tr align=center>";
		str += "<tr><td width=120>共" + row + "条记录</td><td width=120>第" + npage
				+ "/" + spage + "页</td>";
		str += "<td style='display:inline;'><a target='" + target + "' href='" + http
	...
	public static String table(int row, int page, String http) {
		return table(2*FinalConstants.STEP, row, page, http, "_self");
	}
}
