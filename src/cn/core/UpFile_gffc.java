    ...
    { 
       ...
       try{  
    	   String tempFileName=(String)session.getId();//客户的session的id
            File f1=new File("G:/web/wzcszy/WebContent/images/gffc",tempFileName);
           ...
           //客户上传的文件的名字是：
            ...
            session.setAttribute("gpic",fileName);//session传值
            ...
            File f2= new File("G:/web/wzcszy/WebContent/images/gffc",fileName); 
