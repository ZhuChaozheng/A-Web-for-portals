...
public class Database {
	  ...
	  private static String dbUrl =
	      "jdbc:mysql://127.0.0.1:3306/db_hhugfs?user=root&password=111&useUnicode=true";
    public Database() {
	    try {
		      ...
		      dbUrl = prop.getProperty("DB_URL",
		                               "jdbc:mysql://127.0.0.1:3306/db_hhugfs?user=root&password=111&useUnicode=true&characterEncoding=gbk");
		    }
		    catch (Exception e) {
