...
<DIV id=wrapper><!--中间部分  -->
 <%BasetableFactory bf=BasetableFactory.getInstance();
  int lid=ParamUtils.getIntParameter(request,"lid");
      ...
      Collection coll=bf.ListNew(submit_page,"where lid="+lid+" order by utime desc");
      %>
...
<TBODY>
 <%
     if(lid==0){%>
     <TR>
<TD class=biaoti31 align=center>学习生活</TD></TR></TBODY></TABLE></TD></TR>
<TR>
<TD>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
...
<TBODY>
<TR>
<TD class=biaoti32 style="PADDING-LEFT: 15px" height=30><A href="list_bid.jsp?bid=0" target=_self>学习生活</A></TD></TR>
<TR>
...
<A title=学习生活 href="list_bid.jsp?bid=0">学习生活</A></TD></TR>
<TR>
<TD height=10 colSpan=2></TD></TR>
<TR>
<TD class=biaoti32 height=30 colSpan=2>学习生活</TD></TR>
      <%}%>
      <%
     if(lid==1){%>
     <TR>
<TD class=biaoti31 align=center>招生选拔</TD></TR></TBODY></TABLE></TD></TR>
<TR>
<TD>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
...
<TBODY>
<TR>
<TD class=biaoti32 style="PADDING-LEFT: 15px" height=30><A href="list_bid.jsp?bid=1" target=_self>招生选拔</A></TD></TR>
<TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD></TR>
<TD bgColor=#d5d5d5 height=1 width=207>
</TD>
...
<TD height=20 colSpan=2><A title=返回首页 href="index.jsp">首页</A>
<SPAN class=posSplit>&nbsp;</SPAN>
<A title=招生选拔 href="list_bid.jsp?bid=1">招生选拔</A></TD></TR>
<TR>
<TD height=10 colSpan=2></TD></TR>
<TR>
<TD class=biaoti32 height=30 colSpan=2>招生选拔</TD></TR>
      <%}%>
      <%
     if(lid==2){%>
     <TR>
<TD class=biaoti31 align=center>新闻热点</TD></TR></TBODY></TABLE></TD></TR>
<TR>
<TD>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
...
<TBODY>
<TR>
<TD class=biaoti32 style="PADDING-LEFT: 15px" height=30><A href="list_bid.jsp?bid=2" target=_self>新闻热点</A></TD></TR>
<TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD></TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD></TR>
</TBODY>
...
<TD height=20 colSpan=2><A title=返回首页 href="index.jsp">首页</A>
<SPAN class=posSplit>&nbsp;</SPAN>
<A title=新闻热点 href="list_bid.jsp?bid=0">新闻热点</A></TD></TR>
<TR>
<TD height=10 colSpan=2></TD></TR>
<TR>
<TD class=biaoti32 height=30 colSpan=2>新闻热点</TD></TR>
      <%}%>
      <%
     if(lid==10){%>
     <TR>
...
<TBODY>
<TR>
<TD class=biaoti32 style="PADDING-LEFT: 15px" height=30><A href="list_lid.jsp?lid=10" target=_self>军政训练</A></TD></TR>
<TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD></TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD>
<TR>
<TD class=biaoti32 style="PADDING-LEFT: 15px" height=30><A href="list_lid.jsp?lid=20" target=_self>学风建设</A></TD></TR>
<TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD></TR>
<TD bgColor=#d5d5d5 height=1 width=207></TD>
</TBODY>
...
<TD height=20 colSpan=2><A title=返回首页 href="index.jsp">首页</A>
<SPAN class=posSplit>&nbsp;</SPAN>
<A title=军政训练 href="list_bid.jsp?bid=10">军政训练</A></TD></TR>
<TR>
<TD height=10 colSpan=2></TD></TR>
<TR>
<TD class=biaoti32 height=30 colSpan=2>军政训练</TD></TR>
      <%}%>
         <%
     if(lid==20){%>
     <TR>
...
<TD height=20 colSpan=2><A title=返回首页 href="index.jsp">首页</A>
<SPAN class=posSplit>&nbsp;</SPAN>
<A title=学风建设 href="list_bid.jsp?bid=10">学风建设</A></TD></TR>
<TR>
<TD height=10 colSpan=2></TD></TR>
<TR>
<TD class=biaoti32 height=30 colSpan=2>学风建设</TD></TR>
      <%}%>
<TR>
...
<TBODY>
 <tr align="center"> 
    ...
    <%=HtmlUtils.table(bf.getRow("new where lid="+lid),submit_page,"list_lid.jsp")%></td> 
  </tr>   <%}%> 
